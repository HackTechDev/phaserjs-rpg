...
class Level extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet({
            key: 'player',
            url: "game/assets/playera.png",
            frameConfig: {frameWidth: 48,  //The width of the frame in pixels.
                          frameHeight: 64, //The height of the frame in pixels. Uses the frameWidth value if not provided.
